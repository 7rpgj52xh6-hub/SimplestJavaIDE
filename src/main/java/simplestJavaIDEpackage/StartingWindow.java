        ...
        if (fileChooser
          ...
          if (fileChooser.getSelectedFile().getAbsolutePath().contains(" ")) {
            ...
            if (fileChooser.getSelectedFile().exists()) {
              ...
              CodingFile codingFile = FileManager.load(file1.getName().replace(fileFormat, ""),
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (fileChooser
          ...
          if (fileChooser.getSelectedFile().getAbsolutePath().contains(" ")) {
            ...
            ErrorPopupWindow.throwMessage("File name can't start with a number. Please reselect.");
          } else if (fileChooser.getSelectedFile().getName().replaceFirst(fileFormat, "")
              .contains(".")) {
            ErrorPopupWindow
                .throwMessage("File path can't contain any period/dot. Please reselect.");
          } else {
            ...
            if (!file.exists()) {
              ...
              try {
                file.createNewFile();
                CodingFile codingFile = FileManager.load(file.getName().replace(fileFormat, ""),
